...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(DOCUMENT) private document: Document,
   private renderer: Renderer2, router: Router, public authService: AuthService) { 
  ...
  ngOnInit(): void {
    this.menuItems = MENU;
     /* if(this.authService.hasRole('ROLE_ADMIN')){
        ...
        var pos = this.menuItems.findIndex(i => i.label === 'Usuarios');
        this.menuItems.splice(pos, 1);
        var pos = this.menuItems.findIndex(i => i.link === '/generalus/usuario');
        this.menuItems.splice(pos, 1);
      }*/
    /**
