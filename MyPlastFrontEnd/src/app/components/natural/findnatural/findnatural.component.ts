...
@Component({
  selector: 'app-findnatural',
  templateUrl: './findnatural.component.html',
  styleUrls: []
})
export class FindnaturalComponent implements OnInit {
  ...
  constructor(private naturalService: NaturalService,public modalservice: ModalService,
     private formingresocom: FormingresoComponent) { }
...
seleccionarNatural(natural: Natural){
    ...
    this.formingresocom.ingreso.id_PERSONA = natural;
    this.formingresocom.actualizarCamposNatural();
    this.modalservice.cerrarModal2();
}
