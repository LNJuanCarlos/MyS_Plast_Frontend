...
import { FormordenprodComponent } from '../../ordenprod/formordenprod/formordenprod.component';
...
@Component({
  selector: 'app-naturalop',
  templateUrl: './naturalop.component.html',
  styleUrls: []
})
export class NaturalopComponent implements OnInit {
  ...
  constructor(private naturalService: NaturalService,public modalservice: ModalService,
     private formordenprodcom: FormordenprodComponent) { }
...
seleccionarNatural(natural: Natural){
    ...
    this.formordenprodcom.ordenprod.id_PERSONA = natural;
    this.formordenprodcom.actualizarCamposNatural();
    this.modalservice.cerrarModal2();
}
